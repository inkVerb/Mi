...
# Deskscreen (virtual monitor sharing)
yay -S --noconfirm deskreen-bin
modprobe vkms
## For automation
### Get old desktop monitor config (enabling mod vkms will re-write this setting, so lets put it back)
#old_monitor_setting="$(/usr/bin/su ${VRK_USER} -c "dconf read /org/gnome/shell/extensions/dash-to-panel/available-monitors")"
...
#/usr/bin/su ${VRK_USER} -c "dconf write /org/gnome/shell/extensions/dash-to-panel/available-monitors '${old_monitor_setting}'"
